...
--
-- Host: localhost:3306
-- Generation Time: Jul 02, 2015 at 12:40 AM
...
(3, 'Product 3', 160000, 'product 3 product 3  product 3  product 3  product 3 ', '10945159_1608654019366861_2106977424_n.jpg', '143581151826312781.jpeg', '1435812090san30.jpg', 0, '2015-06-16 02:04:42', '2015-07-02 11:41:30'),
...
(30, 'User sakd21321', '230094681eb7d16628005800d221bdbb', 0, 0, 'trustinjesus.tvb94@yahoo.com.vn', '1435821774dfdffg5.jpg', '2015-07-02 02:22:38', '2015-07-02 02:23:37');
...
--
ALTER TABLE `product`
  MODIFY `pd_id` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=79;
--
-- AUTO_INCREMENT for table `user`
--
ALTER TABLE `user`
  MODIFY `user_id` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=31;--
-- Database: `ntq-project-v2`
--
...
CREATE TABLE IF NOT EXISTS `category` (
  ...
  `ct_time_created` datetime NOT NULL,
  `ct_time_updated` datetime NOT NULL
...
('2015_06_30_080200_create_category_table', 1),
('2015_06_30_080222_create_product_table', 1),
('2015_06_30_083601_create_product_table', 2),
('2015_06_30_083649_create_users_table', 2);
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `pd_time_created` datetime NOT NULL,
  `pd_time_updated` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `user_pass` varchar(60) COLLATE utf8_unicode_ci NOT NULL,
  `user_status` tinyint(4) NOT NULL,
  `user_privilege` tinyint(4) NOT NULL,
  `user_email` varchar(60) COLLATE utf8_unicode_ci NOT NULL,
  `user_img` varchar(90) COLLATE utf8_unicode_ci DEFAULT NULL,
  `user_time_created` datetime NOT NULL,
  `user_time_updated` datetime NOT NULL
...
INSERT INTO `users` (`user_id`, `user_username`, `user_pass`, `user_status`, `user_privilege`, `user_email`, `user_img`, `user_time_created`, `user_time_updated`) VALUES
(1, 'kay', 'a32145a237b6fe9e63bfe9216f965e01', 1, 1, '', NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00');
